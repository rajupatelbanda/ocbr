                    ...
                    <div class="col-md-3">
                        <nav class="navbar bg-light">
                            <ul class="navbar-nav">
                                ...
                                @foreach ($catageries as $cat)
                                <li class="nav-item">
                                    <a class="nav-link" href="{{url('category/'.$cat->slug)}}"><i class="fa fa-child"></i>{{$cat->name}}</a>
                                </li>
                                @endforeach
                            </ul>
                        </nav>
                    ...
                    <div class="col-lg-3">
                        <div class="product-item">
                            <div class="product-title">
                                <a href="{{ url('product-detail/' . Str::slug($tp->product_name))  }}">{{$tp->product_name}}</a>
                                <div class="ratting">
                            ...
                            <div class="product-image">
                                <a href="{{ url('product-detail/' . Str::slug($tp->product_name))  }}">
                                    <img src="{{ asset('images/products/'.$tp->image) }}" alt="Product Image" height="120px">
                                </a>
                            ...
                            <div class="product-price">
                                <h3><span>$</span>{{ $tp->selling_price }}</h3>
